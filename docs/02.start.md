...
- Repositories > New repository
  - Repository name: febc11-final
  - Description: Front-End BootCamp 11기 파이널 프로젝트
  - Public 선택
  - Create repository
...
```sh
npm create vite@latest febc11-final
```
...
* Git 원격 저장소 연결
```sh
git remote add origin https://github.com/계정/febc11-final.git
```
